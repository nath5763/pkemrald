...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_PORYGONZ]    = BACK_ANIM_H_VIBRATE,
    ...
    [SPECIES_MUNCHLAX]   = BACK_ANIM_DIP_RIGHT_SIDE,
    ...
    [SPECIES_TOGEKISS]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    ...
    [SPECIES_MISMAGIUS]  = BACK_ANIM_H_VIBRATE,
    [SPECIES_HONCHKROW]  = BACK_ANIM_H_SHAKE,
    ...
    [SPECIES_GLISCOR]     = BACK_ANIM_SHRINK_GROW,
    ...
    [SPECIES_WEAVILLE]   = BACK_ANIM_TRIANGLE_DOWN,
    ...
    [SPECIES_MAMOSWINE]  = BACK_ANIM_H_SHAKE,
    ...
    [SPECIES_ELECTIVIRE] = BACK_ANIM_H_SHAKE,
    ...
    [SPECIES_PROBOPASS]   = BACK_ANIM_V_SHAKE_LOW,
    ...
    [SPECIES_FROSLASS]   = BACK_ANIM_TRIANGLE_DOWN,
    ...
    [SPECIES_BUDEW]      = BACK_ANIM_SHAKE_GLOW_GREEN,
    [SPECIES_ROSELIA]    = BACK_ANIM_SHAKE_GLOW_GREEN,
    [SPECIES_ROSERADE]   = BACK_ANIM_SHAKE_GLOW_GREEN,
