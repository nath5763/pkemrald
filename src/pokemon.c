...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_MAGNEZONE - 1]   = ANIM_TUMBLING_FRONT_FLIP,
    ...
    [SPECIES_MAGMORTAR - 1]   = ANIM_H_SHAKE,
    ...
    [SPECIES_TOGEKISS - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_MISMAGIUS - 1]   = ANIM_V_SLIDE_WOBBLE,
    [SPECIES_HONCHKROW - 1]   = ANIM_V_SLIDE,
    ...
    [SPECIES_GLISCOR - 1]      = ANIM_SHRINK_GROW,
    ...
    [SPECIES_MAMOSWINE - 1]   = ANIM_H_SHAKE,
    ...
    [SPECIES_PORYGONZ - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_ELECTIVIRE -1]   = ANIM_FLASH_YELLOW,
    ...
    [SPECIES_PROBOPASS - 1]    = ANIM_BOUNCE_ROTATE_TO_SIDES_SLOW,
    ...
    [SPECIES_GALLADE - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    case EVO_MODE_NORMAL:
        ...
        for (i = 0; i < EVOS_PER_MON; i++)
        {
            ...
            case EVO_GENDER_FEMALE:
                if (GetMonGender(mon) == MON_FEMALE && level >= gEvolutionTable[species][i].param)
                    targetSpecies = gEvolutionTable[species][i].targetSpecies;
                break;
            case EVO_GENDER_MALE:
                if (GetMonGender(mon) == MON_MALE && level >= gEvolutionTable[species][i].param)
                    targetSpecies = gEvolutionTable[species][i].targetSpecies;
                break;
            }
        }
