...
const u8 gText_PkmnNatureChangedToVar2[] = _("{STR_VAR_1}'s nature changed\nto {STR_VAR_2}.");
const u8 gText_PkmnAbilityChangedToVar2[] = _("{STR_VAR_1}'s ABILITY changed\nto {STR_VAR_2}!");
const u8 gText_PkmnDoesntHaveTwoAbilities[] = _("That POKéMON doesn't have\ntwo different ABILITIES.");
