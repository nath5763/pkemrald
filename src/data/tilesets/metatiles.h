...
const u16 gMetatiles_cave[] = INCBIN_U16("data/tilesets/primary/cave/metatiles.bin");
const u16 gMetatileAttributes_cave[] = INCBIN_U16("data/tilesets/primary/cave/metatile_attributes.bin");
