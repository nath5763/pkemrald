...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .species = SPECIES_SHIFTRY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_NEEDLE_ARM, MOVE_NIGHT_SLASH, MOVE_SWAGGER, MOVE_PSYCHO_CUT}
    },
    {
    .iv = 250,
    .lvl = 61,
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_PSYCHIC, MOVE_HAIL, MOVE_ICE_BEAM}
    },
    {
    .iv = 250,
    .lvl = 63,
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ENERGY_BALL, MOVE_SURF, MOVE_AURORA_BEAM, MOVE_WATER_PULSE}
    },
    {
    .iv = 250,
    .lvl = 55,
    ...
    .moves = {MOVE_WATERFALL, MOVE_DRAGON_DANCE, MOVE_OUTRAGE, MOVE_SUBSTITUTE}
    }
};
...
static const struct TrainerMonItemCustomMovesAbility sParty_Wallace[] = {
    ...
    .moves = {MOVE_CURSE, MOVE_BODY_SLAM, MOVE_EARTHQUAKE, MOVE_PROTECT},
    .abilityNum = 1,
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_THUNDERBOLT, MOVE_WILL_O_WISP, MOVE_AURA_SPHERE},
    .nature = NUM_NATURES
    },
    {
    .iv = 255,
    ...
    .species = SPECIES_HERACROSS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CLOSE_COMBAT, MOVE_EARTHQUAKE, MOVE_XSCISSOR, MOVE_PROTECT},
    .nature = NUM_NATURES
    },
    {
    .iv = 255,
    ...
    .moves = {MOVE_DRAGON_DANCE, MOVE_DRAGON_CLAW, MOVE_FIRE_FANG, MOVE_ROCK_SLIDE},
    .nature = NUM_NATURES
    },
    {
    .iv = 255,
    ...
    .species = SPECIES_GOREBYSS,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_AURA_SPHERE, MOVE_SURF, MOVE_PSYCHIC, MOVE_TIDAL_RING},
    .nature = NUM_NATURES
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Leaf[] = {
    ...
    .species = SPECIES_BELLOSSOM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAMETHROWER, MOVE_LEAF_STORM, MOVE_TAIL_GLOW, MOVE_SUBSTITUTE}
    },
    {
    .iv = 255,
    .lvl = 60,
    ...
    .species = SPECIES_EXEGGUTOR,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SOLAR_BEAM, MOVE_PSYCHIC, MOVE_PSYCHIC, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 255,
    .lvl = 60,
    ...
    .species = SPECIES_ROSERADE,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_LEAF_STORM, MOVE_ICE_BEAM, MOVE_EXTRASENSORY}
    },
