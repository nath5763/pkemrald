...
static const struct TrainerMonNoItemCustomMoves sParty_ShellyWeatherInstitute[] = {
    {
    .iv = 50,
    .lvl = 36,
    .species = SPECIES_MIGHTYENA,
    .moves = {MOVE_CRUNCH, MOVE_TAUNT, MOVE_SWAGGER, MOVE_PROTECT}
    },
    {
    .iv = 50,
    .lvl = 36,
    .species = SPECIES_SHARPEDO,
    .moves = {MOVE_WATERFALL, MOVE_CRUNCH, MOVE_ICE_BEAM, MOVE_PROTECT}
    },
    {
    .iv = 50,
    .lvl = 38,
...
static const struct TrainerMonNoItemCustomMoves sParty_ShellySeafloorCavern[] = {
    {
    .iv = 100,
    .lvl = 52,
    .species = SPECIES_SHARPEDO,
    .moves = {MOVE_WATERFALL, MOVE_CRUNCH, MOVE_ICE_FANG, MOVE_PROTECT}
    },
    {
    .iv = 100,
    .lvl = 54,
    .species = SPECIES_MIGHTYENA,
    .moves = {MOVE_CRUNCH, MOVE_TAUNT, MOVE_SWAGGER, MOVE_ROAR}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Archie[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_SURF, MOVE_AERIAL_ACE},
    },
    {
    .iv = 150,
    .lvl = 52,
    ...
    .moves = {MOVE_THUNDER, MOVE_ICE_BEAM, MOVE_SURF, MOVE_PSYCHIC},
    },
    {
    .iv = 150,
    .lvl = 52,
    .species = SPECIES_FERALIGATR,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_WATERFALL, MOVE_CRUNCH, MOVE_AQUA_JET, MOVE_CLOSE_COMBAT},
    },
    {
    .iv = 150,
    .lvl = 52,
    .species = SPECIES_CROBAT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BRAVE_BIRD, MOVE_CROSS_POISON, MOVE_CONFUSE_RAY, MOVE_SLASH},
    },
    {
    .iv = 150,
    .lvl = 53,
    .species = SPECIES_SHARPEDO,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_WATERFALL, MOVE_CRUNCH, MOVE_ICE_FANG, MOVE_THUNDER_FANG},
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Wendy[] = {
    ...
    .moves = {MOVE_PSYCHIC, MOVE_YAWN, MOVE_HEAL_BELL, MOVE_TAKE_DOWN}
    },
    {
    .iv = 100,
    .lvl = 43,
    .species = SPECIES_ROSERADE,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SLUDGE_BOMB, MOVE_GRASS_WHISTLE, MOVE_LEECH_SEED}
    },
    {
    .iv = 100,
    .lvl = 43,
    .species = SPECIES_HONCHKROW,
    .moves = {MOVE_NIGHT_SLASH, MOVE_WING_ATTACK, MOVE_NIGHT_SHADE, MOVE_ASTONISH}
    }
};
...
static const struct TrainerMonItemCustomMovesAbility sParty_Sidney[] = {
    {
    .iv = 250,
    .lvl = 61,
    .species = SPECIES_MIGHTYENA,
    ...
    .species = SPECIES_SHIFTRY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LEAF_BLADE, MOVE_NIGHT_SLASH, MOVE_SWAGGER, MOVE_PSYCHO_CUT},
    .abilityNum = 1
    },
    {
    .iv = 250,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DARK_PULSE, MOVE_FLAMETHROWER, MOVE_ENERGY_BALL, MOVE_THUNDERBOLT},
    .abilityNum = 0
    },
    {
    .iv = 250,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATERFALL, MOVE_SWORDS_DANCE, MOVE_NIGHT_SLASH, MOVE_FACADE},
    .abilityNum = 0
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .moves = {MOVE_BRAVE_BIRD, MOVE_SHADOW_CLAW, MOVE_CURSE, MOVE_CRUSH_CLAW}
    },
    {
    .iv = 250,
    .lvl = 62,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_PUNCH, MOVE_EARTHQUAKE, MOVE_CURSE, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = 250,
    .lvl = 62,
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_PSYCHIC, MOVE_FLAMETHROWER, MOVE_BUG_BUZZ}
    },
    {
    .iv = 250,
    .lvl = 62,
    .species = SPECIES_HUNTAIL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_CLAW, MOVE_CRUNCH, MOVE_WATERFALL, MOVE_CURSE}
    },
    {
    .iv = 250,
    .lvl = 62,
    ...
    .moves = {MOVE_SHADOW_CLAW, MOVE_FIRE_FANG, MOVE_BELLY_DRUM, MOVE_FACADE}
    },
    {
    .iv = 255,
    .lvl = 62,
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_ICE_BEAM, MOVE_THUNDERBOLT, MOVE_ENERGY_BALL}
    }
};

static const struct TrainerMonItemCustomMovesAbility sParty_Glacia[] = {
    {
    .iv = 250,
    .lvl = 63,
    .species = SPECIES_CLOYSTER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_BODY_SLAM, MOVE_HAIL, MOVE_ICE_BEAM},
    .abilityNum = 0
    },
    {
    .iv = 250,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_PROTECT, MOVE_THUNDERBOLT, MOVE_SHADOW_BALL, MOVE_ICE_BEAM},
    .abilityNum = 0
    },
    {
        .iv = 250,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_HAIL, MOVE_BODY_SLAM},
    .abilityNum = 0
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDERBOLT, MOVE_DRAGON_PULSE, MOVE_PROTECT, MOVE_ENERGY_BALL}
    },
    {
    .iv = 250,
    .lvl = 64,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_DRAGON_CLAW, MOVE_DRAGON_DANCE, MOVE_AERIAL_ACE}
    },
    {
    .iv = 250,
    .lvl = 64,
    .species = SPECIES_KINGDRA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_CLAW, MOVE_DRAGON_DANCE, MOVE_WATERFALL, MOVE_BODY_SLAM}
    },
    {
    .iv = 250,
    .lvl = 64,
    .species = SPECIES_FLYGON,
    .heldItem = ITEM_CHOICE_SPECS,
    .moves = {MOVE_FLAMETHROWER, MOVE_DARK_PULSE, MOVE_DRAGON_PULSE, MOVE_EARTH_POWER}
    },
    {
    .iv = 255,
    .lvl = 64,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .species = SPECIES_ARON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_METAL_CLAW, MOVE_ROCK_THROW, MOVE_ROCK_TOMB}
    },
    {
    .iv = 200,
    .lvl = 14,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ASTONISH, MOVE_ACID, MOVE_ABSORB, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_KARATE_CHOP, MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_BULK_UP}
    },
    {
    .iv = 200,
    .lvl = 19,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DOUBLE_KICK, MOVE_FLAME_WHEEL, MOVE_PECK, MOVE_BULK_UP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER_WAVE, MOVE_CONFUSE_RAY, MOVE_WATER_PULSE, MOVE_SHOCK_WAVE}
    },
    {
    .iv = 200,
    .lvl = 25,
    .species = SPECIES_KIRLIA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCK_WAVE, MOVE_PSYBEAM, MOVE_ICY_WIND, MOVE_MAGICAL_LEAF}
    },
    {
    .iv = 220,
    .lvl = 25,
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUPERSONIC, MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE, MOVE_MAGNET_BOMB}
    },
    {
    .iv = 250,
    .lvl = 26,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_INCINERATE, MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE, MOVE_HIDDEN_POWER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SOLAR_BEAM, MOVE_TAKE_DOWN, MOVE_FLAME_WHEEL, MOVE_WING_ATTACK}
    },
    ...
    .species = SPECIES_RAPIDASH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_BOUNCE, MOVE_STOMP, MOVE_FLAME_WHEEL}
    },
    {
    .iv = 250,
    .lvl = 31,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .moves = {MOVE_COUNTER, MOVE_PROTECT, MOVE_BELLY_DRUM, MOVE_EXTREME_SPEED}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AERIAL_ACE, MOVE_BRAVE_BIRD, MOVE_TAKE_DOWN, MOVE_QUICK_ATTACK}
    },
    {
    .iv = 210,
    .lvl = 39,
    ...
    .moves = {MOVE_DRAGON_DANCE, MOVE_AERIAL_ACE, MOVE_WATERFALL, MOVE_HYPER_BEAM}
    },
    {
    .iv = 210,
    .lvl = 39,
    ...
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SAND_ATTACK, MOVE_XSCISSOR, MOVE_STEEL_WING, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 40,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_EARTH_POWER, MOVE_PSYCHIC, MOVE_HYPNOSIS, MOVE_CALM_MIND}
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BATON_PASS, MOVE_CALM_MIND, MOVE_PSYCHIC, MOVE_AURA_SPHERE}
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_TOXIC, MOVE_NIGHT_SLASH, MOVE_CONFUSE_RAY, MOVE_SAND_ATTACK}
    }
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_PULSE, MOVE_ICE_BEAM, MOVE_HYDRO_PUMP, MOVE_AERIAL_ACE}
    },
    {
    .iv = 200,
    .lvl = 54,
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_ENERGY_BALL, MOVE_SURF, MOVE_AURORA_BEAM, MOVE_INGRAIN}
    },
    {
    .iv = 200,
    .lvl = 54,
    ...
    .moves = {MOVE_ICE_PUNCH, MOVE_AQUA_JET, MOVE_TAKE_DOWN, MOVE_EARTHQUAKE}
    },
    ...
    .moves = {MOVE_THUNDER, MOVE_SURF, MOVE_REFLECT, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 200,
    .lvl = 54,
    ...
    .moves = {MOVE_IRON_HEAD, MOVE_RAIN_DANCE, MOVE_HYDRO_CANNON, MOVE_ICY_WIND}
    },
    {
    .iv = 250,
    .lvl = 54,
    ...
    .moves = {MOVE_WATERFALL, MOVE_DRAGON_DANCE, MOVE_DRAGON_CLAW, MOVE_PROTECT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_BenTest[] = {
    {
    .iv = 150,
    .lvl = 77,
    .species = SPECIES_GENGAR,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SHADOW_BALL, MOVE_THUNDERBOLT, MOVE_PROTECT, MOVE_SLUDGE_BOMB}
    },
    {
    .iv = 150,
    .lvl = 77,
    ...
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_METEOR_MASH, MOVE_EARTHQUAKE, MOVE_EXPLOSION}
    },
    {
    .iv = 150,
    .lvl = 77,
    .heldItem = ITEM_SOFT_SAND,
    .species = SPECIES_SWAMPERT,
    .moves = {MOVE_WATERFALL, MOVE_EARTHQUAKE, MOVE_PROTECT, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 150,
    .lvl = 77,
    .heldItem = ITEM_WHITE_HERB,
    .species = SPECIES_ALTARIA,
    .moves = {MOVE_DRAGON_DANCE, MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE, MOVE_BRAVE_BIRD}
    },
    {
    .iv = 150,
    .lvl = 77,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_AEROBLAST, MOVE_EARTH_POWER, MOVE_FLAMETHROWER, MOVE_TRI_ATTACK}
    },
    {
    .iv = 150,
    .lvl = 77,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_INGRAIN, MOVE_PROTECT, MOVE_TOXIC, MOVE_GIGA_DRAIN}
    }
};

static const struct TrainerMonItemCustomMoves sParty_RyanTest[] = {
    {
    .iv = 150,
    .lvl = 82,
    .species = SPECIES_DUSCLOPS,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SKILL_SWAP, MOVE_WILL_O_WISP, MOVE_PAIN_SPLIT, MOVE_NIGHT_SHADE}
    },
    {
    .iv = 150,
    .lvl = 82,
    .heldItem = ITEM_SITRUS_BERRY,
    .species = SPECIES_SLAKING,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_PROTECT}
    },
    {
    .iv = 150,
    .lvl = 82,
    .heldItem = ITEM_WHITE_HERB,
    .species = SPECIES_ALAKAZAM,
    .moves = {MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_PROTECT, MOVE_ENERGY_BALL}
    },
    {
    .iv = 150,
    .lvl = 82,
    ...
    .species = SPECIES_AMPHAROS,
    .moves = {MOVE_DRAGON_PULSE, MOVE_THUNDERBOLT, MOVE_EARTH_POWER, MOVE_PROTECT}
    },
    {
    .iv = 150,
    .lvl = 82,
    ...
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SPORE, MOVE_PROTECT, MOVE_NEEDLE_ARM, MOVE_MACH_PUNCH}
    }
};

static const struct TrainerMonItemCustomMoves sParty_AngieTest[] = {
    {
    .iv = 150,
    .lvl = 87,
    .species = SPECIES_EXEGGUTOR,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_PSYCHIC, MOVE_ENERGY_BALL, MOVE_PROTECT, MOVE_TOXIC}
    },
    {
    .iv = 150,
    .lvl = 87,
    ...
    .moves = {MOVE_FAKE_OUT, MOVE_DETECT, MOVE_CLOSE_COMBAT, MOVE_PURSUIT}
    },
    {
    .iv = 150,
    .lvl = 87,
    .heldItem = ITEM_LEFTOVERS,
    .species = SPECIES_BLASTOISE,
    .moves = {MOVE_SURF, MOVE_FLASH_CANNON, MOVE_PROTECT, MOVE_ICE_BEAM}
    },
    {
    .iv = 150,
    .lvl = 87,
    ...
    .moves = {MOVE_BODY_SLAM, MOVE_SHADOW_PUNCH, MOVE_PROTECT, MOVE_RECYCLE}
    },
    {
    .iv = 150,
    .lvl = 87,
    .species = SPECIES_TYPHLOSION,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_BELLY_DRUM, MOVE_FIRE_FANG, MOVE_SHADOW_CLAW, MOVE_PROTECT}
    },
    {
    .iv = 150,
    .lvl = 87,
    .species = SPECIES_DELCATTY,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FOLLOW_ME, MOVE_PROTECT, MOVE_BODY_SLAM, MOVE_HEAL_BELL}
    }
};

static const struct TrainerMonItemCustomMoves sParty_SirusTest[] = {
    {
    .iv = 150,
    .lvl = 92,
    .heldItem = ITEM_LEFTOVERS,
    .species = SPECIES_NINETALES,
    .moves = {MOVE_FLAMETHROWER, MOVE_PSYCHIC, MOVE_LIGHT_SCREEN, MOVE_REFLECT}
    },
    {
    .iv = 150,
    .lvl = 92,
    .heldItem = ITEM_SITRUS_BERRY,
    .species = SPECIES_SALAMENCE,
    .moves = {MOVE_EARTHQUAKE, MOVE_PROTECT, MOVE_BRAVE_BIRD, MOVE_DRAGON_CLAW}
    },
    {
    .iv = 150,
    .lvl = 92,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_PSYCHIC, MOVE_SURF, MOVE_AEROBLAST, MOVE_ICE_BEAM}
    },
    {
    .iv = 150,
    .lvl = 92,
    .heldItem = ITEM_SITRUS_BERRY,
    .species = SPECIES_HERACROSS,
    .moves = {MOVE_MEGAHORN, MOVE_CLOSE_COMBAT, MOVE_PROTECT, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 150,
    .lvl = 92,
    ...
    .species = SPECIES_UMBREON,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_TOXIC, MOVE_PROTECT, MOVE_WISH, MOVE_DARK_PULSE}
    }
};

static const struct TrainerMonItemCustomMoves sParty_MaxiePost[] = {
    {
    .iv = 150,
    .lvl = 75,
    .heldItem = ITEM_LEFTOVERS,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .species = SPECIES_TORKOAL,
    .moves = {MOVE_OVERHEAT, MOVE_PROTECT, MOVE_BODY_SLAM, MOVE_ATTRACT}
    },
    {
    .iv = 150,
    .lvl = 75,
    .species = SPECIES_CHARIZARD,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_FLAMETHROWER, MOVE_SOLAR_BEAM, MOVE_AEROBLAST, MOVE_EARTH_POWER}
    },
    {
    .iv = 150,
    .lvl = 75,
    .heldItem = ITEM_SITRUS_BERRY,
    .species = SPECIES_CROBAT,
    .moves = {MOVE_CROSS_POISON, MOVE_BRAVE_BIRD, MOVE_PROTECT, MOVE_XSCISSOR}
    },
    {
    .iv = 150,
    .lvl = 75,
    .species = SPECIES_HOUNDOOM,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLAMETHROWER, MOVE_DARK_PULSE, MOVE_ENERGY_BALL, MOVE_PROTECT}
    },
    {
    .iv = 150,
    .lvl = 75,
...
static const struct TrainerMonItemCustomMoves sParty_ArchiePost[] = {
    {
    .iv = 150,
    .lvl = 75,
    .heldItem = ITEM_LEFTOVERS,
    .species = SPECIES_PELIPPER,
    .moves = {MOVE_HYDRO_PUMP, MOVE_AEROBLAST, MOVE_LIGHT_SCREEN, MOVE_REFLECT}
    },
    {
    .iv = 150,
    .lvl = 75,
    .heldItem = ITEM_SITRUS_BERRY,
    .species = SPECIES_LUDICOLO,
    .moves = {MOVE_ENERGY_BALL, MOVE_PROTECT, MOVE_SURF, MOVE_LEECH_SEED}
    },
    {
    .iv = 150,
    .lvl = 75,
    .species = SPECIES_KINGDRA,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_CALM_MIND, MOVE_SURF, MOVE_DRAGON_PULSE, MOVE_ICE_BEAM}
    },
    {
    .iv = 150,
    .lvl = 75,
    .heldItem = ITEM_SITRUS_BERRY,
    .species = SPECIES_WEAVILLE,
    .moves = {MOVE_NIGHT_SLASH, MOVE_CLOSE_COMBAT, MOVE_PROTECT, MOVE_ICE_SHARD}
    },
    {
    .iv = 150,
    .lvl = 75,
    .species = SPECIES_MAMOSWINE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_AVALANCHE, MOVE_PROTECT}
    },
    {
    .iv = 150,
    .lvl = 75,
    .species = SPECIES_FERALIGATR,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_WATERFALL, MOVE_PROTECT, MOVE_ICE_PUNCH, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_EeveeTrainer[] = {
    {
    .iv = 0,
    .lvl = 35,
    .species = SPECIES_ESPEON,
...
static const struct TrainerMonItemCustomMovesAbility sParty_Wallace[] = {
    {
        .iv = 255,
        .lvl = 65,
        .species = SPECIES_GENGAR,
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR1[] = {
    ...
    .lvl = 63,
    .species = SPECIES_ROSERADE,
    .moves = {MOVE_ENERGY_BALL, MOVE_SLUDGE_BOMB, MOVE_LEECH_SEED, MOVE_TOXIC}
    },
    {
    .iv = 150,
    .lvl = 63,
    ...
    .lvl = 62,
    .species = SPECIES_TOGEKISS,
    .moves = {MOVE_AEROBLAST, MOVE_THUNDERBOLT, MOVE_TRI_ATTACK, MOVE_EARTH_POWER}
    },
    {
    .iv = 250,
    .lvl = 63,
...
static const struct TrainerMonNoItemCustomMoves sParty_MaxieMagmaHideout[] = {
    {
    .iv = 150,
    .lvl = 44,
    .species = SPECIES_TORKOAL,
    .moves = {MOVE_OVERHEAT, MOVE_BODY_SLAM, MOVE_ATTRACT, MOVE_WILL_O_WISP},
    },
    {
    .iv = 150,
    .lvl = 44,
    .species = SPECIES_MIGHTYENA,
    .moves = {MOVE_THUNDER_FANG, MOVE_ICE_FANG, MOVE_FIRE_FANG, MOVE_SWAGGER},
    },
    {
    .iv = 150,
    .lvl = 44,
    .species = SPECIES_CROBAT,
    .moves = {MOVE_BRAVE_BIRD, MOVE_CROSS_POISON, MOVE_AERIAL_ACE, MOVE_TOXIC},
    },
    {
    .iv = 150,
    .lvl = 44,
    .species = SPECIES_CAMERUPT,
    .moves = {MOVE_MAGNITUDE, MOVE_OVERHEAT, MOVE_ANCIENT_POWER, MOVE_POWER_GEM},
    },
    {
    .iv = 150,
    .lvl = 44,
    .species = SPECIES_CHARIZARD,
    .moves = { MOVE_SOLAR_BEAM, MOVE_WING_ATTACK, MOVE_FLAMETHROWER, MOVE_ROCK_SLIDE},
    },
    {
        .iv = 150,
        .lvl = 46,
...
static const struct TrainerMonItemCustomMoves sParty_BrendanLilycoveMudkip[] = {
    ...
    .lvl = 46,
    .species = SPECIES_AERODACTYL,
    .moves = {MOVE_BRAVE_BIRD, MOVE_AERIAL_ACE, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE},
    .heldItem = ITEM_NONE,
    },
    {
    .iv = 150,
    .lvl = 46,
    .species = SPECIES_NINETALES,
    .moves = {MOVE_PSYCHIC, MOVE_FLAMETHROWER, MOVE_WILL_O_WISP, MOVE_ENERGY_BALL},
    .heldItem = ITEM_QUICK_CLAW,
    },
    {
    .iv = 150,
    ...
    .lvl = 47,
    .species = SPECIES_SCEPTILE,
    .moves = {MOVE_DRAGON_CLAW, MOVE_DRAGON_DANCE, MOVE_LEAF_BLADE, MOVE_ROCK_SLIDE},
    .heldItem = ITEM_YACHE_BERRY,
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanLilycoveTreecko[] = {
    ...
    .lvl = 46,
    .species = SPECIES_SCIZOR,
    .moves = {MOVE_XSCISSOR, MOVE_BULLET_PUNCH, MOVE_QUICK_ATTACK, MOVE_EARTHQUAKE},
    ...
    .lvl = 46,
    .species = SPECIES_LUDICOLO,
    .moves = {MOVE_SURF, MOVE_ENERGY_BALL, MOVE_LEECH_SEED, MOVE_PROTECT},
    .heldItem = ITEM_LEFTOVERS,
    },
    {
    .iv = 200,
    .lvl = 47,
    .species = SPECIES_BLAZIKEN,
    .moves = {MOVE_CLOSE_COMBAT, MOVE_BLAZE_KICK, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE},
...
static const struct TrainerMonItemCustomMoves sParty_BrendanLilycoveTorchic[] = {
    ...
    .lvl = 46,
    .species = SPECIES_SHIFTRY,
    .moves = {MOVE_LEAF_BLADE, MOVE_CRUNCH, MOVE_SWORDS_DANCE, MOVE_AERIAL_ACE},
    .heldItem = ITEM_SITRUS_BERRY,
    },
    {
    .iv = 150,
    ...
    .lvl = 47,
    .species = SPECIES_SWAMPERT,
    .moves = {MOVE_WATERFALL, MOVE_EARTHQUAKE, MOVE_ICE_PUNCH, MOVE_CLOSE_COMBAT},
...
static const struct TrainerMonNoItemCustomMoves sParty_Kai[] = {
    ...
    .lvl = 30,
    .species = SPECIES_WHISCASH,
    .moves = {MOVE_REST, MOVE_SNORE, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Charlotte[] = {
    ...
    .lvl = 30,
    .species = SPECIES_SHIFTRY,
    .moves = {MOVE_SPORE, MOVE_MAGICAL_LEAF, MOVE_DARK_PULSE, MOVE_PROTECT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_TabithaMagmaHideout[] = {
    {
    .iv = 75,
    .lvl = 45,
    .species = SPECIES_TORKOAL,
    .moves = {MOVE_OVERHEAT, MOVE_BODY_SLAM, MOVE_HEAT_WAVE, MOVE_SMOKESCREEN},
    },
    {
    .iv = 75,
    .lvl = 45,
    .species = SPECIES_VENUSAUR,
    .moves = {MOVE_SOLAR_BEAM, MOVE_SLUDGE_BOMB, MOVE_LEECH_SEED, MOVE_PROTECT},
    },
    {
    .iv = 75,
    .lvl = 45,
    .species = SPECIES_CROBAT,
    .moves = {MOVE_POISON_FANG, MOVE_AERIAL_ACE, MOVE_CONFUSE_RAY, MOVE_BRAVE_BIRD },
    },
    {
    .iv = 75,
    .lvl = 45,
    .species = SPECIES_TYPHLOSION,
    .moves = {MOVE_SEED_BOMB, MOVE_FIRE_FANG, MOVE_SHADOW_CLAW, MOVE_EARTHQUAKE},
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson2[] = {
    ...
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HIDDEN_POWER, MOVE_THUNDER_WAVE, MOVE_THUNDER, MOVE_PROTECT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Steven[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_NIGHT_SLASH, MOVE_PROTECT, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 76,
    .species = SPECIES_AGGRON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_IRON_HEAD, MOVE_DRAGON_CLAW}
    },
    {
    .iv = 255,
    .lvl = 76,
...
static const struct TrainerMonItemCustomMoves sParty_AquaAdminNeymar[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_BREATH, MOVE_DARK_PULSE, MOVE_WATER_PULSE, MOVE_ICE_BALL}
    },
    {
    .iv = 255,
    .lvl = 24,
...
static const struct TrainerMonItemCustomMovesAbility sParty_Leaf[] = {
    {
        .iv = 255,
        .lvl = 61,
...
// Champion's Club Floor 2 placeholder parties. These are intentionally kept
// separate so each notable trainer can receive a full custom team later.
#define CHAMPIONS_CLUB_MAGIKARP_PARTY(partyName)                  \
static const struct TrainerMonItemCustomMovesAbility partyName[] = { \
    {                                                           \
        .iv = 0,                                                \
        .lvl = 5,                                              \
        .species = SPECIES_MAGIKARP,                            \
...
CHAMPIONS_CLUB_MAGIKARP_PARTY(sParty_ChampionsClubRoxanne);
CHAMPIONS_CLUB_MAGIKARP_PARTY(sParty_ChampionsClubBrawly);
CHAMPIONS_CLUB_MAGIKARP_PARTY(sParty_ChampionsClubWattson);
CHAMPIONS_CLUB_MAGIKARP_PARTY(sParty_ChampionsClubFlannery);
CHAMPIONS_CLUB_MAGIKARP_PARTY(sParty_ChampionsClubNorman);
CHAMPIONS_CLUB_MAGIKARP_PARTY(sParty_ChampionsClubWinona);
CHAMPIONS_CLUB_MAGIKARP_PARTY(sParty_ChampionsClubTateAndLiza);
CHAMPIONS_CLUB_MAGIKARP_PARTY(sParty_ChampionsClubJuan);
CHAMPIONS_CLUB_MAGIKARP_PARTY(sParty_ChampionsClubSidney);
CHAMPIONS_CLUB_MAGIKARP_PARTY(sParty_ChampionsClubPhoebe);
CHAMPIONS_CLUB_MAGIKARP_PARTY(sParty_ChampionsClubGlacia);
CHAMPIONS_CLUB_MAGIKARP_PARTY(sParty_ChampionsClubDrake);
CHAMPIONS_CLUB_MAGIKARP_PARTY(sParty_ChampionsClubWallace);
CHAMPIONS_CLUB_MAGIKARP_PARTY(sParty_ChampionsClubSteven);
CHAMPIONS_CLUB_MAGIKARP_PARTY(sParty_ChampionsClubLeaf);
CHAMPIONS_CLUB_MAGIKARP_PARTY(sParty_ChampionsClubBrendan);
CHAMPIONS_CLUB_MAGIKARP_PARTY(sParty_ChampionsClubMay);

#undef CHAMPIONS_CLUB_MAGIKARP_PARTY
