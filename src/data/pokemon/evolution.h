const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_GRAVELER]   = {{EVO_LEVEL, 34, SPECIES_GOLEM}},
    ...
    [SPECIES_PORYGON2]   = {{EVO_LEVEL, 40, SPECIES_PORYGONZ}},
    ...
    [SPECIES_TOGETIC]     = {{EVO_LEVEL, 40, SPECIES_TOGEKISS}},
    ...
    [SPECIES_PILOSWINE]  = {{EVO_LEVEL, 40, SPECIES_MAMOSWINE}},
    ...
    [SPECIES_SKITTY]     = {{EVO_FRIENDSHIP, 0, SPECIES_DELCATTY}},
    ...
    [SPECIES_SNORUNT]    = {{EVO_GENDER_MALE, 30, SPECIES_GLALIE},
                            {EVO_GENDER_FEMALE, 30, SPECIES_FROSLASS}},
    ...
    [SPECIES_KIRLIA]     = {{EVO_GENDER_FEMALE, 30, SPECIES_GARDEVOIR},
                            {EVO_GENDER_MALE, 30, SPECIES_GALLADE}},
    ...
    [SPECIES_MISDREAVUS] = {{EVO_LEVEL, 30, SPECIES_MISMAGIUS}},
    [SPECIES_MURKROW]    = {{EVO_LEVEL, 30, SPECIES_HONCHKROW}},
    [SPECIES_SNEASEL]    = {{EVO_LEVEL, 34, SPECIES_WEAVILLE}},
    [SPECIES_GLIGAR]     = {{EVO_LEVEL, 34, SPECIES_GLISCOR}},
    [SPECIES_RHYDON]     = {{EVO_LEVEL, 42, SPECIES_RHYPERIOR}},
    [SPECIES_NOSEPASS]   = {{EVO_LEVEL, 34, SPECIES_PROBOPASS}},
    [SPECIES_BUDEW]      = {{EVO_LEVEL, 12, SPECIES_ROSELIA}},
    [SPECIES_MUNCHLAX]   = {{EVO_LEVEL, 27, SPECIES_SNORLAX}},
    [SPECIES_BONSLY]     = {{EVO_LEVEL, 25, SPECIES_SUDOWOODO}},
    [SPECIES_LICKITUNG]  = {{EVO_LEVEL, 40, SPECIES_LICKILICKY}},
    [SPECIES_TANGELA]    = {{EVO_LEVEL, 40, SPECIES_TANGROWTH}},
    [SPECIES_AIPOM]      = {{EVO_LEVEL, 40, SPECIES_AMBIPOM}},
