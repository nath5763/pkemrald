const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(RHYPERIOR, gMonFrontPic_Rhydon),
    ...
    SPECIES_SPRITE(BONSLY, gMonFrontPic_Sudowoodo),
    ...
    SPECIES_SPRITE(WEAVILLE, gMonFrontPic_Weaville),
    ...
    SPECIES_SPRITE(BUDEW, gMonFrontPic_Roselia),
    SPECIES_SPRITE(MUNCHLAX, gMonFrontPic_Snorlax),
