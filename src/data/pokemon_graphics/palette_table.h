const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(RHYPERIOR, gMonPalette_Rhydon),
    ...
    SPECIES_PAL(BONSLY, gMonPalette_Sudowoodo),
    ...
    SPECIES_PAL(WEAVILLE, gMonPalette_Weaville),
    ...
    SPECIES_PAL(BUDEW, gMonPalette_Roselia),
    SPECIES_PAL(MUNCHLAX, gMonPalette_Snorlax),
