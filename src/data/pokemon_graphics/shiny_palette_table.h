const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(RHYPERIOR, gMonShinyPalette_Rhydon),
    ...
    SPECIES_SHINY_PAL(MUNCHLAX, gMonShinyPalette_Snorlax),
    ...
    SPECIES_SHINY_PAL(BONSLY, gMonShinyPalette_Sudowoodo),
    ...
    SPECIES_SHINY_PAL(WEAVILLE, gMonShinyPalette_Weaville),
    ...
    SPECIES_SHINY_PAL(BUDEW, gMonShinyPalette_Roselia),
