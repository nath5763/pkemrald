const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(RHYPERIOR, gMonBackPic_Rhydon),
    ...
    SPECIES_SPRITE(MUNCHLAX, gMonBackPic_Snorlax),
    ...
    SPECIES_SPRITE(BONSLY, gMonBackPic_Sudowoodo),
    ...
    SPECIES_SPRITE(WEAVILLE, gMonBackPic_Weaville),
    ...
    SPECIES_SPRITE(BUDEW, gMonBackPic_Roselia),
