const struct CompressedSpriteSheet gMonStillFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(RHYPERIOR,     gMonStillFrontPic_Rhydon),
    ...
    SPECIES_SPRITE(MUNCHLAX,      gMonStillFrontPic_Snorlax),
...
// Gen II
    ...
    SPECIES_SPRITE(BONSLY,        gMonStillFrontPic_Sudowoodo),
    ...
    SPECIES_SPRITE(WEAVILLE,       gMonStillFrontPic_Weaville),
...
// Gen III
    ...
    SPECIES_SPRITE(BUDEW,         gMonStillFrontPic_Roselia),
