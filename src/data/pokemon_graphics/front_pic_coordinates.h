...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_MAGNEZONE]   = { .size = MON_COORDS_SIZE(32, 24), .y_offset = 21 },
    ...
    [SPECIES_MAGMORTAR]   = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  4 },
    ...
    [SPECIES_PORYGONZ]     = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 13 },
    ...
    [SPECIES_TOGEKISS]    = { .size = MON_COORDS_SIZE(32, 48), .y_offset =  9 },
    ...
    [SPECIES_HONCHKROW]   = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 11 },
    [SPECIES_SLOWKING]    = { .size = MON_COORDS_SIZE(40, 64), .y_offset =  1 },
    [SPECIES_MISDREAVUS]  = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 12 },
    [SPECIES_MISMAGIUS]   = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 12 },
    ...
    [SPECIES_GLISCOR]      = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  3 },
    ...
    [SPECIES_WEAVILLE]     = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  5 },
    ...
    [SPECIES_MAMOSWINE]   = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    ...
    [SPECIES_ELECTIVIRE]  = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 10 },
    ...
    [SPECIES_PROBOPASS]    = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 12 },
    ...
    [SPECIES_FROSLASS]      = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 10 },
    ...
    [SPECIES_ROSERADE]     = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  8 },
    ...
    [SPECIES_BUDEW]       = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  8 },
    [SPECIES_MUNCHLAX]    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  5 },
