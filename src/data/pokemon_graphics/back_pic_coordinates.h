...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_MAGNEZONE]   = { .size = MON_COORDS_SIZE(32, 24), .y_offset = 20 },
    ...
    [SPECIES_MAGMORTAR]   = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    ...
    [SPECIES_PORYGONZ]     = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 13 },
    ...
    [SPECIES_HONCHKROW]   = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  9 },
    [SPECIES_SLOWKING]    = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    [SPECIES_MISDREAVUS]  = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 10 },
    [SPECIES_MISMAGIUS]   = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 10 },
    ...
    [SPECIES_GLISCOR]      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  5 },
    ...
    [SPECIES_MAMOSWINE]   = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 13 },
    ...
    [SPECIES_ELECTIVIRE]  = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    ...
    [SPECIES_PROBOPASS]    = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 12 },
    ...
    [SPECIES_FROSLASS]    = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 12 },
    ...
    [SPECIES_ROSERADE]     = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  8 },
    ...
    [SPECIES_GALLADE]   = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  4 },
